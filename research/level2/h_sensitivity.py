...
from decisionmemory.data.models import OHLCVSeries, Timeframe
from decisionmemory.simulation.agent import BaseAgent, SimulatedDecision
    ...
    for symbol in SYMBOLS:
        for tf_str, tf_enum in TIMEFRAMES.items():
            ...
            for strategy in all_strategies:
                ...
                if r_is.fitness.decision_count >= MIN_IS_DECISIONS:
