...
SYSTEM_PROMPT = """You are a quantitative decision_making researcher analyzing historical price data.
Your task is to discover repeatable decision_making patterns from OHLCV data.
...
DISCOVERY_PROMPT = """Analyze this {timeframe} OHLCV data for {symbol} and discover {count} decision_making patterns.
...
MUTATION_PROMPT = """You are given a decision_making pattern that showed some promise but needs improvement.
