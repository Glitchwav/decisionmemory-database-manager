...
from decisionmemory.data.context_builder import MarketContext, build_context
from decisionmemory.data.models import OHLCV, OHLCVSeries
from decisionmemory.evolution.llm import LLMClient, LLMMessage, LLMResponse
...
from decisionmemory.evolution.prompts import (
    DISCOVERY_PROMPT,
    MUTATION_PROMPT,
    SYSTEM_PROMPT,
)
...
async def mutate_pattern(
    ...
    prompt = MUTATION_PROMPT.format(
        ...
        decision_count=fitness.decision_count,
