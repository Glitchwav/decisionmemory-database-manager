...
from decisionmemory.evolution.backtester import backtest
from decisionmemory.evolution.engine import EngineConfig, EvolutionEngine
from decisionmemory.evolution.generator import GenerationConfig, HypothesisGenerator
from decisionmemory.evolution.llm import LLMClient
...
async def discover_patterns(
    ...
    *,
    ...
    """Discover decision_making patterns from market data using LLM.

    Args:
        symbol: DecisionMaking pair
