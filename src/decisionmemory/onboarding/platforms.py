...
MCP_COMMAND = "uvx decisionmemory-protocol"
MCP_FALLBACK = "python -m decisionmemory"
...
PLATFORMS: Dict[str, dict] = {
    ...
    "claude_code": {
        ...
        "config_path": None,
        "snippet": None,
        "auto_install_cmd": "claude mcp add decisionmemory -- uvx decisionmemory-protocol",
        "instructions": [
    ...
    "smithery": {
        ...
        "config_path": None,
        "snippet": None,
        "auto_install_cmd": "npx -y @smithery/cli install decisionmemory-protocol",
        "instructions": [
            "Run the following command:",
            "  npx -y @smithery/cli install decisionmemory-protocol",
        ],
    },
    "docker": {
        "name": "Docker",
        ...
        "auto_install_cmd": None,
        "instructions": [
            "Run DecisionMemory in a container:",
            "  docker run -it --rm -v decisionmemory-data:/root/.decisionmemory ghcr.io/mnemox-ai/decisionmemory-protocol",
            "",
...
def show_config_menu(platform_key: Optional[str] = None) -> None:
    ...
    print(f"\nUsage: decisionmemory config <platform>")
    print(f"Example: decisionmemory config claude_code\n")
