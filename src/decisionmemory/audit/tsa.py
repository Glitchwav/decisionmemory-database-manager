...
GlobalSign, etc.) by setting `DECISIONMEMORY_TSA_URL`.
...
TSA_URL_ENV = "DECISIONMEMORY_TSA_URL"
...
def request_timestamp(
    ...
    Args:
        ...
        tsa_url: Override TSA endpoint (default: $DECISIONMEMORY_TSA_URL or freetsa.org).
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "decisionmemory-protocol/0.5.2 (+https://github.com/mnemox-ai/decisionmemory-protocol)",
        },
        method="POST",
    )
