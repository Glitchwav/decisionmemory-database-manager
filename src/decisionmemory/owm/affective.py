...
EWMA confidence tracks emotional momentum from recent decision outcomes.
...
def ewma_confidence(outcomes: list[float], lam: float = 0.9) -> float:
    """Compute exponentially weighted moving average of decision outcomes as confidence.
