...
collectively supports or opposes a proposed decision_making direction.

Definition
----------
Given a set of similar past decisions (refs) and a proposed direction for the
...
Evidence interpretation (per ref):
  - Past decision same direction & profitable  -> supports proposed direction
  - Past decision same direction & loss        -> opposes (warns repetition)
  - Past decision opposite direction & profit  -> opposes (the other side worked)
  - Past decision opposite direction & loss    -> supports (validates avoiding it)
