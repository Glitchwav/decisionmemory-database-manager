...
Detects behavioral regime changes in decision_making agent observations using
...
class BayesianChangepoint:
    """Bayesian Online Changepoint Detection for decision_making agent behavior.
    ...
    def update(self, observation: Dict[str, Any]) -> ChangePointResult:
        ...
        Args:
            observation: Dict with keys:
                - won (bool): required — decision was profitable
        ...
        # Adaptive target: use observed win rate after 20+ decisions, not hardcoded 0.5
