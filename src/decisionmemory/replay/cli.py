"""CLI entry point for the XAUUSD LLM DecisionMaking Agent Replay Engine."""
...
from decisionmemory.replay.engine import run_replay
from decisionmemory.replay.models import ReplayConfig


def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="XAUUSD LLM DecisionMaking Agent Replay Engine",
        prog="decisionmemory.replay",
    )
    ...
    parser.add_argument(
        "--use-memory",
        action="store_true",
        help="Enable memory recall from past decisions before each LLM decision",
    )
