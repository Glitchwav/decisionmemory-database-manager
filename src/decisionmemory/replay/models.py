"""Pydantic models for the LLM DecisionMaking Agent Replay Engine."""
...
class IndicatorSnapshot(BaseModel):
    ...
    - ATR(14, D1): needs 15 D1 bars = 1440 M15 bars (~15 decision_making days)
...
class ReplayConfig(BaseModel):
    ...
    # with your own strategy rules (e.g. from decision-dreaming package)
    ...
    # Provider time offset from UTC (FXTM: +2 winter, +3 summer)
    provider_utc_offset: int = 2
