"""Memory recall for replay: query episodic_memory for similar past decisions."""
...
def build_memory_context(
    ...
    """Query episodic_memory for similar past decisions and format as prompt context.
