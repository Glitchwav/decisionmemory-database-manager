...
class StateManager:
    ...
    def add_active_position(self, agent_id: str, decision_id: str) -> bool:
        """
        Add a decision to active positions list.
        ...
        if decision_id not in state.active_positions:
            state.active_positions.append(decision_id)

        return self.save_state(state)

    def remove_active_position(self, agent_id: str, decision_id: str) -> bool:
        """
        Remove a decision from active positions list.
        ...
        if decision_id in state.active_positions:
            state.active_positions.remove(decision_id)
