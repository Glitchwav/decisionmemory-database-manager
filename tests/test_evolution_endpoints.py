...
class TestEvolutionDiscover:
    @patch("decisionmemory.evolution.mcp_tools.discover_patterns", new_callable=AsyncMock)
    @patch("decisionmemory.evolution.llm.AnthropicClient")
...
class TestEvolutionBacktest:
    @patch("decisionmemory.evolution.mcp_tools.run_backtest", new_callable=AsyncMock)
...
class TestEvolutionEvolve:
    @patch("decisionmemory.evolution.mcp_tools.evolve_strategy", new_callable=AsyncMock)
    @patch("decisionmemory.evolution.llm.AnthropicClient")
...
class TestEvolutionLog:
    @patch("decisionmemory.evolution.mcp_tools.get_evolution_log")
