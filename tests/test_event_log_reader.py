...
class TestEventLogReaderMatch:
    """Test matching DECISION_OPEN by pos_id."""
        ...
        _write_csv(csv_path, [
            {
                ...
                "evt": "DECISION_OPEN", "decision": "SELL", "reason": "pos_id=7047640363",
    ...
    def test_no_match_returns_fallback(self, tmp_event_log_dir):
        ...
        _write_csv(csv_path, [
            {
                "ts": "2026.03.24 07:55:05", "evt": "DECISION_OPEN",
...
class TestEventLogReaderDecision:
    ...
    def test_decision_event_provides_score(self, tmp_event_log_dir):
        ...
        _write_csv(csv_path, [
            ...
            {
                "ts": "2026.02.24 09:49:25", "evt": "DECISION_OPEN",
...
class TestEventLogReaderConfidence:
    ...
    def test_low_spread_high_atr_boosts_confidence(self, tmp_event_log_dir):
        ...
        _write_csv(csv_path, [
            {
                "ts": "2026.03.24 10:00:00", "evt": "DECISION_OPEN",
