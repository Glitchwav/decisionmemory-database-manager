...
PERFORMANCE:
Decisions: 5 | Winners: 3 | Losers: 2
...
def test_validate_missing_required_fields(reflection):
    ...
    missing_decisions = """=== DAILY SUMMARY: 2026-02-23 ===
...
"""
    ...
    assert reflection._validate_llm_output(missing_decisions, target_date) is False
...
PERFORMANCE:
Decisions: 1 | Winners: 1 | Losers: 0
