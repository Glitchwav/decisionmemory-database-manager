...
class TestSLTPLong:
    def test_sl_hit_long(self):
        tracker = PositionTracker(lot_size=0.10, initial_score=10000.0)
...
class TestClosePosition:
    def test_close_eod(self):
        ...
        assert tracker.score == pytest.approx(10250.0)
...
class TestPnLCalculation:
    def test_pnl_win_long(self):
        tracker = PositionTracker(lot_size=0.20, initial_score=10000.0)
        tracker.open_position(
        ...
        assert tracker.score == pytest.approx(12000.0)
    ...
    def test_pnl_loss_short(self):
        ...
        assert tracker.score == pytest.approx(9500.0)
...
class TestScoreDrawdown:
    def test_drawdown_after_loss(self):
        ...
        # Lost 500 → score 9500, peak 10000, dd = 5%
        assert tracker.score == pytest.approx(9500.0)
        assert tracker.peak_score == pytest.approx(10000.0)
