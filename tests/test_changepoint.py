...
from decisionmemory.owm.changepoint import BayesianChangepoint, ChangePointResult
...
def test_no_changepoint_stable_series():
    """50 decisions at ~60% win rate should NOT trigger a changepoint."""
...
def test_detect_mean_shift():
    """30 decisions at 70% win rate → 30 decisions at 30% should detect a changepoint."""
