...
# --- Simulated score curves ---
np.random.seed(42)

# Round 1: downward score curve (Sharpe -1.20)
...
# Round 2 Strategy C: upward score curve (Sharpe 1.90)
...
# === Plot score curves inside boxes ===
chart_pad_x = 1.5
chart_pad_y = 2
chart_h = 10
...
# === Title ===
ax.text(50, 38, 'I Let AI Invent Its Own DecisionMaking Strategies',
...
out_path = r'C:\Users\johns\projects\decisionmemory-protocol\docs\blog-cover.png'
