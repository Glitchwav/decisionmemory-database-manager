...
**Date:** 2026-03-25
**Scope:** decisionmemory-protocol + idea-reality-mcp
**Status:** Approved
...
```
💡 First time? Run: decisionmemory setup
```

Detection: check for `.decisionmemory_setup_done` marker file in data dir.
...
- Scores are algorithmic estimates, not decision context research
