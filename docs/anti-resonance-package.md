...
|------------------------|---------------------|
| Agent recalls 10 winning decisions | Agent recalls 8 wins + 2 outcome setbacks |
...
6. API reference
7. Used in: DecisionMemory Protocol (link)
...
- Decision-Making system developers concerned about survivorship bias
