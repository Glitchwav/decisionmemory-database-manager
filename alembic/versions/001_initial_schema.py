...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("decision_references", JSONB(), nullable=False, server_default="[]"),
    ...
    op.create_index("idx_decision_timestamp", "decision_records", ["timestamp"])
    op.create_index("idx_decision_strategy", "decision_records", ["strategy"])
