"""
DecisionMemory Services Launcher (silent, for Startup folder)
Starts: decisionmemory FastAPI server + mt5_sync.py + daily_reflection scheduler.
...
PROJECT = Path(r"C:\Users\johns\projects\decisionmemory-protocol")
...
# Start decisionmemory FastAPI server
