@echo off
REM ============================================================
REM  DecisionMemory Services Stopper
REM  Stops: decisionmemory FastAPI server + mt5_sync.py
REM ============================================================

echo Stopping DecisionMemory services...

REM --- Find and kill Python processes on port 8000 ---
for /f "tokens=5" %%p in ('netstat -aon ^| findstr ":8000" ^| findstr "LISTENING"') do (
    echo Killing decisionmemory server (PID %%p)...
