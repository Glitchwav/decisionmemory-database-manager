#!/usr/bin/env bash
# DecisionMemory Protocol — One-Click Install Script
# Usage: curl -sSL https://raw.githubusercontent.com/mnemox-ai/decisionmemory-protocol/master/scripts/platform/install.sh | bash
# Or:    bash install.sh

set -e

REPO="https://github.com/mnemox-ai/decisionmemory-protocol.git"
DIR="decisionmemory-protocol"
MIN_PYTHON="3.10"
...
echo "    python -m decisionmemory  # Start MCP server"
echo ""
echo "  For full setup, edit .env with your credentials."
echo "  Docs: https://github.com/mnemox-ai/decisionmemory-protocol"
echo ""
