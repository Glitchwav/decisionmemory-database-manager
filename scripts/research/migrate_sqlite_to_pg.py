"""
One-time migration: SQLite (data/decisionmemory.db) → PostgreSQL.

Usage:
    python scripts/research/migrate_sqlite_to_pg.py
    python scripts/research/migrate_sqlite_to_pg.py --sqlite data/decisionmemory.db --pg postgresql://decisionmemory:decisionmemory@localhost:5432/decisionmemory
...
JSON_COLUMNS = {
    "decision_records": {"market_context", "decision_references", "tags"},
...
TIMESTAMP_COLUMNS = {
    "decision_records": {"timestamp", "exit_timestamp"},
...
def main():
    ...
    parser.add_argument(
        "--sqlite",
        default="data/decisionmemory.db",
        help="Path to SQLite database (default: data/decisionmemory.db)",
    )
    parser.add_argument(
        "--pg",
        default="postgresql://decisionmemory:decisionmemory@localhost:5432/decisionmemory",
