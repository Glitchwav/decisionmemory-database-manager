...
from decisionmemory.evolution.random_baseline import compute_percentile_rank
...
ORIGINAL_RESULTS = {
    ...
    "bars": 15288,
    "Strategy C": {"sharpe": 3.3952, "percentile": 96.9, "decisions": 130, "win_rate": 0.438, "pf": 2.10},
    "Strategy E": {"sharpe": 4.4175, "percentile": 100.0, "decisions": 161, "win_rate": 0.460, "pf": 2.62},
}
...
async def main():
    ...
    strategy_results = {
        "Strategy C": {
            ...
            "decisions": metrics_c.decision_count,
        ...
        "Strategy E": {
            ...
            "decisions": metrics_e.decision_count,
    ...
    for name, r in strategy_results.items():
        print(f"  {name}: Sharpe={r['sharpe']:.4f}, decisions={r['decisions']}, "
    ...
    print(f"\n{'Strategy':<20} {'Sharpe':>8} {'Pctile':>8} {'Decisions':>8} "
    ...
    for name in ["Strategy C", "Strategy E"]:
        ...
        print(f"{name:<20} {r['sharpe']:>8.4f} {r['percentile']:>7.1f}% "
              f"{r['decisions']:>8d} {r['win_rate']:>7.1%} {r['pf']:>8.2f} "
    ...
    for strat in ["Strategy C", "Strategy E"]:
        ...
        print(f"    {'Decisions':<16} {ext['decisions']:>10d}              {ori['decisions']:>10d}")
