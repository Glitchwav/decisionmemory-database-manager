...
def generate_before_after(theme_name):
    ...
    # Right card (With DecisionMemory)
    right_x = W - 60 - card_w
    ...
    draw.text((right_x + 30, card_y + 20), "有 DecisionMemory",
    ...
    draw.text((W//2 + 60, bar_y + 12), "DecisionMemory：", fill=hex_to_rgb(t["text2"]), font=compare_font)
