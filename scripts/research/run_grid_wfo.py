...
from decisionmemory.evolution.backtester import _compute_fitness
from decisionmemory.evolution.models import CandidatePattern, FitnessMetrics
...
async def main():
    ...
    for p in periods:
        ...
        if reevo_result.best_candidate and reevo_result.passed_dsr_gate:
            ...
            arm_g_decisions = reevo_result.best_candidate.oos_fitness.decision_count
        ...
        print(f"      Sharpe={arm_g_sharpe:.4f}, decisions={arm_g_decisions}, "
