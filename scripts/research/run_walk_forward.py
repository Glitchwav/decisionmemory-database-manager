...
async def main():
    ...
    for w in windows:
        ...
        for name, pattern in strategies.items():
            ...
            window_result = {
                ...
                "is_decisions": is_metrics.decision_count,
                "is_win_rate": is_metrics.win_rate,
                "is_pnl": is_metrics.total_pnl,
                "oos_sharpe": oos_metrics.sharpe_ratio,
                "oos_decisions": oos_metrics.decision_count,
    ...
    for name in strategies:
        ...
        oos_decisions = [r["oos_decisions"] for r in window_results]
        ...
        total_oos_decisions = sum(oos_decisions)
        ...
        summary = {
            ...
            "total_oos_decisions": total_oos_decisions,
    ...
    if all_pass:
        ...
        print("-> Proceed to Step 3 (Live Paper DecisionMaking)")
    elif any_pass:
