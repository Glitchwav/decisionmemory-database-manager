...
# Suppress noisy per-decision logs from owm_helpers
...
async def main():
    from decisionmemory.simulation.runner import run_full_experiment

    # Note: 15m excluded initially (105K bars too slow for per-decision DB writes).
