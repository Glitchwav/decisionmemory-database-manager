...
from decisionmemory.evolution.models import EvolutionConfig
...
def analyze_hypothesis(h, idx):
    ...
    is_decisions = h.fitness_is.decision_count if h.fitness_is else 0
    ...
    print(f"      IS Sharpe: {is_sharpe:.4f} | IS decisions: {is_decisions}" if is_sharpe is not None else "      IS: N/A")
